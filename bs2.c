...
void about() {
    ...
    printf("!!!ABOUT US!!!");
    gotoxy(32,12);
    printf("This project has been created by Shafayet Islam.");
    gotoxy(10,13);
    printf("It is a Simple Banking activities System Project for my 3rd Semester based on C programming language.");
    gotoxy(40, 22);
    printf("Press any key to return back to main menu. ");
    char z = getch();
    if (z == 13) {
